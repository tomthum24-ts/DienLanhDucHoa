...
/*!
 * fullpage.js Drop Effect Extension 0.0.3 for fullPage.js v3
...
/* eslint-disable */ (function () {
  window.fp_dropEffectExtension = function () {
    var o,
      a,
      r,
      s,
    ...
    function V(e) {
      ...
      t && u.closest(t, n + " a")
        ? function (e) {
            k && (e.stopImmediatePropagation(), e.preventDefault());
          }.call(t, e)
        : u.closest(t, m.menu + " [data-menuanchor]") &&
          function (e) {
            k && e.preventDefault();
          }.call(t, e);
    }
    function X() {
      k && (($ = !0), document.body.classList.add("fp-drop-no-animation"));
    }
    function Y(e) {
      return (
        (e === w
        ...
        (e + ".active{visibility: visible;opacity: 1;z-index: 1}")
      );
    }
    function j(e) {
      (f.animation1.speed = e), (f.animation2.speed = e);
    }
    function q(e) {
      var t,
        n = void 0 !== e.slides && "none" !== e.xMovement;
      (!Q("slides") && n) || (!Q("sections") && !n)
        ? (t = s.scrollingSpeed)
        : ((t = f.speed ? f.speed : m.scrollingSpeed), (o = t)),
        c.setScrollingSpeed(t);
    }
    (i.afterLoad = function () {}),
      (i.onLeave = function (e) {
        if (!d) {
          var t = e.activeSection.getAttribute("data-drop");
          ("all" === t || e.direction === t) && p
            ? i.turnOn()
            : (i.destroy("internal"),
              (e.dtop = v.getDestinationPosition(e.element)));
        }
      }),
      (i.isAnimating = function () {
        return k;
      }),
      (i.init = function () {
        if (!K()) {
          ...
          (e = l(h)[0]),
            ...
            e.addEventListener("destroy", J),
            e.addEventListener("afterResponsive", G),
            ["click", "touchstart"].forEach(function (e) {
              document.addEventListener(e, V);
            }),
            (d = !l(".fp-section[data-drop]").length),
            (s = u.deepExtend({}, m)),
            (r = s.autoScrolling),
            (f = u.deepExtend(P, m.dropEffectOptions)),
            ...
            U(y, t),
            (function () {
              (x = document.createElement("div")).classList.add("fp-effect-1"),
                ...
                M.setAttribute("viewBox", "0 0 1280 720"),
                M.setAttribute("fill", f.color),
                (I = document.createElementNS(
                  "http://www.w3.org/2000/svg",
                  "path"
                )).setAttribute(
                  "d",
                  "M640,2 C858.65,2 1071.985,1.337 1280,0.011 L1280,2.273 L0,2.273 L0,0.011 C208.015,1.337 421.348,2 640,2 Z"
                ),
                I.setAttribute(
                  "data-path1",
                  "M640,360 C858.651,360 1071.985,240.666 1280,2 L1280,2.273 L0,2.273 L0,2 C208.015,240.666 421.348,360 640,360 Z"
                ),
                I.setAttribute(
                  "data-path2",
                  "M640,720 C754.276,720 967.609,720 1280,720 L1280,2.274 L0,2.274 L0,720 C312.11,720 525.443,720 640,720 Z"
                );
              var e = document.querySelector(".fp-effect-1");
              e && e.parentNode.removeChild(e);
              M.appendChild(I),
                x.appendChild(O),
                document.body.appendChild(x),
                (N = I.getAttribute("d")),
                (z = I.getAttribute("data-path1")),
                (D = I.getAttribute("data-path2"));
            })(),
            ...
            Z.setAttribute("viewBox", "0 0 720 1280"),
            Z.setAttribute("fill", f.color),
            (F = document.createElementNS(
              "http://www.w3.org/2000/svg",
              "path"
            )).setAttribute(
              "d",
              "M2,640 C2,858.65 1.337,1071.985 0.011,1280 L2.273,1280 L2.273,0 L0.011,0 C1.337,208.015 2,421.348 2,640 Z"
            ),
            F.setAttribute(
              "data-path1",
              "M360,640 C360,858.651 240.666,1071.985 2,1280 L2.273,1280 L2.273,0 L2,0 C240.666,208.015 360,421.348 360,640 Z"
            ),
            F.setAttribute(
              "data-path2",
              "M720,640 C720,754.276 720,967.609 720,1280 L2.274,1280 L2.274,0 L720,0 C720,312.11 720,525.443 720,640 Z"
            ),
            Z.appendChild(F),
            (T = F.getAttribute("d")),
            (B = F.getAttribute("data-path1")),
            (R = F.getAttribute("data-path2")),
            c.setAutoScrolling(!0),
            (m.scrollBar = !1),
            (m.animateAnchor = !1);
          var n = Q("slides") ? Y(w) : "",
            i = Q("sections") ? Y(b) : "";
          m.dropEffect && U(C, i + n), v.removeAnimation(l(L)), (p = !0);
        }
      });
    var H = !(i.destroy = function (e) {
      if (p && !_) {
        var t = l(h)[0];
        v.removeAnimation(t),
          ...
          (k = !1),
          u.remove(l("#fp-drop-animation")),
          u.remove(l(S)),
          u.remove(l(A)),
          x.parentNode.removeChild(x),
          window.removeEventListener("hashchange", X),
          t && t.removeEventListener("destroy", J),
          c.setScrollingSpeed(s.scrollingSpeed),
          c.setAutoScrolling(r);
        var n = l(E, l(".fp-section.active")[0])[0];
        null != n && "internal" !== e && (v.silentLandscapeScroll(n), (p = !1)),
          (m.dropEffect = !1),
          (_ = !0);
      }
    });
    function G(e) {
      e.detail && !_
        ? ((H = !(r = !1)), i.destroy())
        : H && ((r = s.autoScrolling), i.turnOn(), (H = !1));
    }
    function J(e) {
      i.destroy(), (p = !1);
    }
    ...
    function Q(e) {
      return !0 === m.dropEffect || m.dropEffect === e;
    }
    function U(e, t) {
      if (!l("#" + e).length) {
    ...
    (i.turnOn = function () {
      (m.dropEffect = s.dropEffect),
        K() ||
          (i.init(),
          (_ = !1),
          window.scrollTo(0, 0),
          Q("sections") && v.silentScroll(0));
    }),
      (i.apply = function (e) {
        if (!e.localIsResizing && "none" !== e.xMovement) {
          if (!k && f.color && u.isArrayOrList(f.color)) {
            var t = e.sectionIndex,
              n = f.color[t];
            n && void 0 !== n && i.setColor(n);
          }
          document.body.classList.add("fp-is-drop-animating"),
            $ || document.body.classList.remove("fp-drop-no-animation"),
            j(m.scrollingSpeed ? a : 0),
            q(e),
            i.performMovement(e),
            (e.dtop = v.getDestinationPosition(e.element));
        }
      }),
      (i.performMovement = function (a) {
        void 0 === a.element &&
          ((a.element = a.destiny),
          void 0 !== a.direction && (a.direction, a.xMovement));
        var e =
          "right" === a.direction ||
          "left" === a.direction ||
          !0 === m.dropEffect;
        if ((!Q("slides") && e) || (!Q("sections") && !e))
          return (
            u.addClass(a.element, g),
            void u.removeClass(u.siblings(a.element), g)
          );
        var r = "up" === a.direction || "down" === a.direction,
          s = r ? "up" === a.direction : "left" == a.direction;
        if (!k && !_) {
          k = !0;
          var d, l, c, p;
          x.classList.toggle("effect-vertical", r),
            x.classList.toggle("effect-horizontal", !r),
            (d = r ? I : F),
            (l = r ? z : B),
            (c = r ? D : R),
            (p = r ? N : T);
          var t = r ? Z : M,
            n = r ? M : Z;
          null != t.parentNode && t.parentNode.removeChild(t), O.appendChild(n);
          var i = r ? "scaleY" : "scaleX";
          x.setAttribute(
            "style",
            s ? "transform: " + i + "(-1)" : "transform: " + i + "(1)"
          ),
            ...
            anime({
              targets: d,
              d: [
                { value: l, easing: f.animation1.easeIn },
                { value: c, easing: f.animation1.easeOut },
              ],
              duration: f.animation1.speed,
              complete: function (e) {
                var t, n, i, o;
                u.addClass(a.element, g),
                  u.removeClass(u.siblings(a.element), g),
                  u.isFunction(m.dropLeaves) &&
                    m.dropLeaves.apply(a.element, [
                      v.nullOrSection(a.activeSection),
                      v.nullOrSection(a.element),
                      a.direction,
                    ]),
                  (n = (t = {
                    isVerticalMovement: r,
                    isInverted: s,
                    $path: d,
                    path1: l,
                    path2: c,
                  ...
                  (i = t.isInverted ? 1 : -1),
                  (o = t.v),
                  x.setAttribute("style", "transform: " + n + "(" + i + ")"),
                  ...
                  anime({
                    targets: t.$path,
                    d: [
                      { value: t.path1, easing: f.animation2.easeIn },
                      { value: t.path0, easing: f.animation2.easeOut },
                    ],
                    duration: f.animation2.speed,
                    complete: function (e) {
                      (k = !1),
                        x.classList.remove("active"),
                        u.isFunction(m.dropEnds) &&
                          m.dropEnds.apply(o.element, [
                            o.activeSection,
                            o.element,
                            o.direction,
                          ]);
      ...
      (i.setColor = function (e) {
        (m.dropEffectOptions.color = e),
          M.setAttribute("fill", e),
          Z.setAttribute("fill", e);
      }),
      (i.setOption = function (e, t) {
        ({
          speed: function () {
            (a = (t - 100) / 2), q({ xMovement: "none" }), j(a);
          },
          color: function () {
            i.setColor(t);
          },
          direction: function () {
            i.destroy(),
              (s.dropEffect = t),
              (m.dropEffectOptions.color = m.dropEffectOptions.color),
              (m.dropEffectOptions.speed = m.dropEffectOptions.speed),
              i.turnOn();
          },
        }[e]());
      }),
      (i.c = v.c);
    var W = i["common".charAt(0)];
    return (
      "complete" === document.readyState && W("dropEffect"),
